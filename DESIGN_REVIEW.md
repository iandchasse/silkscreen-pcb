...
| R14 | **Applied 2026-09-18: 3 Ω → 2.2 Ω, Yageo `RC0603FR-072R2L` `C112307`** — same 0603 1% series/price as the prior part. Matches the SSD1677 reference design's sense resistor now that L1 (above) is also at the reference value. Modeled safe against every component rating; **not bench-verified** — see §7. |
...
| U13 / SW6 | **Standard-build policy (2026-09-17):** U13 (DS3231MZ+TRL, `C107410` — the reel listing; the earlier cut-tape `C722467` is superseded) is populated; SW6 (APEM MJTP1243 boot button) is DNP. The source DNP set is exactly TP3/TP4/TP5, R43/R45/R58/R66/R72/R74 and SW6 — ten references, flagged DNP in both schematic and board so the Toolkit CPL agrees. Upload BOM: `production/bom_JLC_upload_v4_optimized.csv` (updated 2026-09-18 for L1/R14/C9; v3 is the brand-conservative variant) — see `fabrication/BOM.md` for the swap rationale and cost model. |
...
| Assembly counts | 179 references = **162 fitted + 10 DNP + 7 bare-copper** (H1–H5, TP1, TP2) on 2026-09-18; the 2026-09-16 audit counted 173 = 155 + 8 + 10, and older “163 placed” sourcing totals are historical. |
